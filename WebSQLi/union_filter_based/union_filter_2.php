<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $illegal_words = [" union "]; #choosing one of the words in the list at random to filter out
        ...
        if ($result = $conn->query( "SELECT name, company FROM customers where email = '$data' UNION SELECT username, password FROM users WHERE surname = '$data'")) { #dynamic_query
            echo "<br/>";
